const index = 4;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-7E_xDBhE.js')).default;
const universal = {
  "ssr": false,
  "csr": true
};
const universal_id = "src/routes/map/+page.ts";
...
const stylesheets = ["_app/immutable/assets/4.CIGW-MKW.css"];
const fonts = [];

export { component, fonts, imports, index, stylesheets, universal, universal_id };
//# sourceMappingURL=4-DSxLtibI.js.map
