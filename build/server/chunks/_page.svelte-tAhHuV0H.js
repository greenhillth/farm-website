import { t as push, z as escape_html, y as attr, G as ensure_array_like, K as bind_props, v as pop } from './index-B80co9zT.js';
...
function _page($$payload, $$props) {
  ...
  const headers = log.length && log[0] !== null && typeof log[0] === "object" && !Array.isArray(log[0]) ? Object.keys(log[0]) : [];
  const titles = {
    outdoor: "Outdoor",
    indoor: "Indoor",
    solar: "Solar and UVI",
  ...
  if (log.length) {
    ...
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      ...
      $$payload.out.push(`<th class="border-b px-2 py-1 font-medium">${escape_html(h)}</th>`);
    }
    ...
    for (let $$index_2 = 0, $$length = each_array_1.length; $$index_2 < $$length; $$index_2++) {
      ...
      for (let $$index_1 = 0, $$length2 = each_array_2.length; $$index_1 < $$length2; $$index_1++) {
        ...
        $$payload.out.push(`<td class="border-b px-2 py-1">${escape_html(row?.[h] ?? "")}</td>`);
      }
      $$payload.out.push(`<!--]--></tr>`);
    }
...
//# sourceMappingURL=_page.svelte-tAhHuV0H.js.map
