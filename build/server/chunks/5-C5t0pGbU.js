const index = 5;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-f9yHkOVo.js')).default;
const universal = {
  "ssr": false,
  "csr": true
};
...
const stylesheets = ["_app/immutable/assets/5._3FwJddv.css"];
const fonts = [];

export { component, fonts, imports, index, stylesheets, universal, universal_id };
//# sourceMappingURL=5-C5t0pGbU.js.map
