import { h as head, b as ensure_array_like, a as attr, e as escape_html } from "../../../chunks/index2.js";
...
function _page($$renderer) {
  ...
  head("1p1s7xb", $$renderer, ($$renderer2) => {
    $$renderer2.title(($$renderer3) => {
      $$renderer3.push(`<title>Operations manual | Greenhill Bros Farm</title>`);
    });
  });
  $$renderer.push(`<header class="container mx-auto flex items-center justify-between gap-4 px-4 py-4"><a href="/" class="text-muted text-sm hover:text-white">← Back to home</a> <div class="text-muted text-xs">Operations manual</div></header> <main class="container mx-auto space-y-5 px-4 pb-12">`);
  Panel($$renderer, {
    title: "Welcome to the farm manual",
    children: ($$renderer2) => {
      $$renderer2.push(`<div class="text-muted space-y-4 text-sm leading-relaxed"><p>This guide walks through the key screens in the farm webapp and how to keep soil data up to
  ...
  Panel($$renderer, {
    ...
    children: ($$renderer2) => {
      $$renderer2.push(`<div class="space-y-4"><p class="text-muted text-sm leading-relaxed">Every feature follows the same structure, so once you are comfortable in one page you can
      ...
      for (let $$index_1 = 0, $$length = each_array_1.length; $$index_1 < $$length; $$index_1++) {
        ...
        $$renderer2.push(`<li class="space-y-1"><div class="font-medium text-white">${escape_html(step.title)}</div> <p>${escape_html(step.detail)}</p></li>`);
      }
      $$renderer2.push(`<!--]--></ol> <div class="border-border/40 text-muted rounded-lg border bg-white/5 px-4 py-3 text-xs">Shortcut: right-click or press Ctrl/Cmd + click on any card or link to open it in a new tab
  ...
  Panel($$renderer, {
    ...
    children: ($$renderer2) => {
      $$renderer2.push(`<div class="space-y-4"><p class="text-muted text-sm leading-relaxed">These are the core tools in the app today. Each one lives behind a card on the home screen
  ...
  Panel($$renderer, {
    ...
    children: ($$renderer2) => {
      $$renderer2.push(`<div class="space-y-4"><p class="text-muted text-sm leading-relaxed">Keep the Soil tests table current by either entering single samples manually or importing a
      ...
      $$renderer2.push(`<!--]--></ol></section> <section class="border-border/40 rounded-lg border bg-white/5 p-4"><h4 class="text-sm font-semibold text-white">CSV import</h4> <ol class="text-muted mt-3 list-decimal space-y-2 pl-5 text-sm leading-relaxed"><!--[-->`);
      const each_array_5 = ensure_array_like(csvSteps);
      for (let $$index_5 = 0, $$length = each_array_5.length; $$index_5 < $$length; $$index_5++) {
        let step = each_array_5[$$index_5];
        $$renderer2.push(`<li>${escape_html(step)}</li>`);
      }
      $$renderer2.push(`<!--]--></ol></section></div> <div class="border-border/40 text-muted rounded-lg border bg-white/5 p-4 text-xs leading-relaxed"><h5 class="text-sm font-semibold text-white">CSV column checklist</h5> <p class="mt-1">Match your column names to the uploader and include as many metric columns as you have
  ...
  Panel($$renderer, {
    ...
    children: ($$renderer2) => {
      $$renderer2.push(`<div class="grid gap-3 md:grid-cols-3"><!--[-->`);
      const each_array_7 = ensure_array_like(supportTips);
      for (let $$index_7 = 0, $$length = each_array_7.length; $$index_7 < $$length; $$index_7++) {
        let tip = each_array_7[$$index_7];
        $$renderer2.push(`<article class="border-border/40 text-muted rounded-lg border bg-white/5 p-4 text-sm leading-relaxed"><h4 class="text-sm font-semibold text-white">${escape_html(tip.title)}</h4> <p class="mt-2">${escape_html(tip.description)}</p></article>`);
      }
      $$renderer2.push(`<!--]--></div>`);
    },
    $$slots: { default: true }
