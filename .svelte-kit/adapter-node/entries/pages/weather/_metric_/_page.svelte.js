import { e as escape_html, a as attr, b as ensure_array_like, c as bind_props } from "../../../../chunks/index2.js";
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (history.length) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="overflow-x-auto"><table class="min-w-full text-left text-sm"><thead><tr><!--[-->`);
      const each_array = ensure_array_like(columns);
      for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
        let h = each_array[$$index];
        $$renderer2.push(`<th class="border-b px-2 py-1 font-medium">${escape_html(h === "timestamp_utc" ? "Timestamp" : h)}</th>`);
      }
      ...
      for (let $$index_2 = 0, $$length = each_array_1.length; $$index_2 < $$length; $$index_2++) {
        ...
        for (let $$index_1 = 0, $$length2 = each_array_2.length; $$index_1 < $$length2; $$index_1++) {
          ...
          $$renderer2.push(`<td class="border-b px-2 py-1">${escape_html(formatValue(h, row?.[h]))}</td>`);
        }
        $$renderer2.push(`<!--]--></tr>`);
      }
      ...
      $$renderer2.push("<!--[!-->");
      $$renderer2.push(`<p class="text-muted text-sm">No recent readings available.</p>`);
    }
