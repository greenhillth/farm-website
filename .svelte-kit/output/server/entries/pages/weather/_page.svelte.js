import { e as escape_html, j as attr_class, a as attr, c as bind_props } from "../../../chunks/index2.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!----></a> <a href="/weather/indoor" class="block transform transition hover:scale-105">`);
    Panel($$renderer2, {
      title: "Indoor",
      className: "h-full",
      children: ($$renderer3) => {
        $$renderer3.push(`<div class="grid grid-cols-2 gap-4"><div><div class="text-muted mb-1 text-xs">Temperature</div> <div class="text-3xl font-semibold">${escape_html(fmt(w.indoor.temp))}<span class="align-top text-base">°C</span></div> <div class="text-muted mt-1 text-xs">${escape_html(arrow(w.indoor.trend))}
    ...
    $$renderer2.push(`<!----></a> <a href="/weather/battery" class="block transform transition hover:scale-105">`);
    Panel($$renderer2, {
      title: "Battery",
      className: "h-full",
      children: ($$renderer3) => {
        $$renderer3.push(`<div class="text-sm"><div class="font-semibold text-green-400">${escape_html(w.battery.status)}</div> <div class="text-muted">${escape_html(w.battery.note)}</div></div>`);
      },
      $$slots: { default: true }
    });
